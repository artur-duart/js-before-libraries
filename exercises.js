...
// 2. Destructuring and Template Literals: Write a function that takes an object representing a person as an argument and returns a string with a greeting message using the person's name and age. Use destructuring to extract the values from the object and Template Literals to create the greeting message.
